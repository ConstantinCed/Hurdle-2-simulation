# -*- coding: utf-8 -*-
"""Hurdle_2_simulation_python_code.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UxqacbJi3S2ZK6Evn54uVzOHah7MN6g0
"""
...
for p in range(0,o):
  ...
  extinct_A = False
  extinct_B = False
  for d in range(1,z): #z can be thought of as the total number of years (or number million years) over which we are doing this
    ...
    #calculating the total number of animals in each species by subtracting number that quantum tunnel
    ...
    if nb_species_after_division_B *3 < 2:
        extinct_B = True
    ...
    if extinct_B:
          nb_species_after_division_B = -1/3
    nb_species_A_list_time_dep_after_division.append(nb_species_after_division_A)
    nb_species_B_list_time_dep_after_division.append(nb_species_after_division_B*3)





    print("since population size of species A is", round(nb_species_after_division_A),"and for population size of species B", round(nb_species_after_division_B*3))
    print(nb_species_after_division_A, nb_species_after_division_B*3)
    ...
    x = list(range(1, len(nb_species_A_list_time_dep_after_division) + 1))
    plt.plot(x,nb_species_A_list_time_dep_after_division,marker='o')
    plt.plot(x,nb_species_B_list_time_dep_after_division,marker='o')
    plt.xlabel('Index + 1')
  ...
  print('for species B', nb_species_B_list_time_dep_after_division*3)
